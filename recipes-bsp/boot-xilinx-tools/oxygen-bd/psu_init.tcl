...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E007C 0x013F3F07 0x01010802
    ...
    mask_write 0XFF5E00C4 0x013F3F07 0x01010300
    ...
    mask_write 0XFF5E00C8 0x013F3F07 0x01010F00
		# Register : AMS_REF_CTRL @ 0XFF5E0108</p>
...
set psu_ddr_init_data {
    ...
    mask_write 0XFD070104 0x001F1F7F 0x0004051C
    ...
    mask_write 0XFD081484 0xFFFFFFFF 0x200E0000
    ...
    mask_write 0XFD0814C4 0xFFFFFFFF 0x200E0000
...
set psu_mio_init_data {
    ...
    mask_write 0XFF180070 0x000000FE 0x00000040
    ...
    mask_write 0XFF180074 0x000000FE 0x00000040
    ...
    mask_write 0XFF180078 0x000000FE 0x000000C0
    ...
    mask_write 0XFF18007C 0x000000FE 0x000000C0
    ...
    mask_write 0XFF180098 0x000000FE 0x00000040
    ...
    mask_write 0XFF18009C 0x000000FE 0x00000040
    ...
    mask_write 0XFF180204 0xF1FFFFFF 0x40000000
    ...
    mask_write 0XFF180208 0xFFFFC0C3 0x00B00000
    ...
    mask_write 0XFF180160 0x000FFFFF 0x000FFFFF
    ...
    mask_write 0XFF180164 0x03FFFFFF 0x03FFC0FF
...
set psu_peripherals_init_data {
    ...
    mask_write 0XFF0A0244 0x03FFFFFF 0x00000080
		# : DIR MODE BANK 2
		# : OUTPUT ENABLE BANK 0
		# : OUTPUT ENABLE BANK 1
    ...
    mask_write 0XFF0A0248 0x03FFFFFF 0x00000080
		# : OUTPUT ENABLE BANK 2
		# : MASK_DATA_0_LSW LOW BANK [15:0]
		# : MASK_DATA_0_MSW LOW BANK [25:16]
		# : MASK_DATA_1_LSW LOW BANK [41:26]
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFF7F0080
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 1US DELAY
    ...
    mask_write 0XFF0A0008 0xFFFFFFFF 0xFF7F0000
		# : MASK_DATA_1_MSW HIGH BANK [51:42]
		# : MASK_DATA_1_LSW HIGH BANK [67:52]
		# : MASK_DATA_1_LSW HIGH BANK [77:68]
		# : ADD 5US DELAY
